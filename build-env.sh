...
case $ION_NAME in 
  ...
  stage)
	...
	export PRELOAD_KEY="0ArzZOLNhEGVqdDUyMENnZEh3ajRXUFU1Z0xWM1pFY0E"
        export ASSET_MAP_KEY="0ArzZOLNhEGVqdFp2MnNNMTFSQS0yMUlVYmtBSTFVdXc"
