...
bin/pycc -x ion.agents.agentctrl.AgentControl recurse=True preload_id="GP05MOAS-GL001_PD,GP05MOAS-GL002_PD,GP05MOAS-GL003_PD" op=config_instance cfg=$thisdir/eai_configs.csv

echo 'Start agents for 3 GP05 glider platform devices'
bin/pycc -x ion.agents.agentctrl.AgentControl recurse=True preload_id="GP05MOAS-GL001_PD,GP05MOAS-GL002_PD,GP05MOAS-GL003_PD" op=start
